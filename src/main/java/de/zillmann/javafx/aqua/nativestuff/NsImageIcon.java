package de.zillmann.javafx.aqua.nativestuff;
...
//	NSImageNameColorPanel ->  Toolkit.getDefaultToolkit().getImage("NSImage://NSColorPanel")
//	COLOR_PANEL("NSColorPanel"), QUICKLOOK_TEMPLATE("NSQuickLookTemplate"), FOLDER_BURNABLE("NSFolderBurnable");
